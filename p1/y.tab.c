...
{
       0,   104,   104,   109,   119,   124,   129,   139,   144
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "$accept", "command", "numero",
  "base", "num", "digito", YY_NULLPTR
};
#endif
...
#line 104 "calc1.y" /* yacc.c:1646  */
    {
                 ...
                 if(eval((yyvsp[0].nodo)) == -1){yyerrok;} else { printf("Base is %d and final number is %d\n", (yyvsp[0].nodo)->base, (yyvsp[0].nodo)->result); };
              }
#line 1294 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 109 "calc1.y" /* yacc.c:1646  */
    {
                  int size = (yyvsp[-1].nodo)->size + (yyvsp[0].nodo)->size;
                  char* fullNum = (char*) malloc (size);
                  fullNum[0] = (yyvsp[-1].nodo)->val[0];
                  for(int i=1;i<size;i++) fullNum[i]=(yyvsp[0].nodo)->val[i-1];
                  (yyval.nodo) = initNode(fullNum, size, 0);
...
#line 1308 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 119 "calc1.y" /* yacc.c:1646  */
    {
                  (yyval.nodo) = initNode((yyvsp[0].nodo)->val, 1, 0);
...
#line 1317 "y.tab.c" /* yacc.c:1646  */
  ...
  case 5:
#line 124 "calc1.y" /* yacc.c:1646  */
    {
                  (yyval.nodo) = initNode((yyvsp[0].nodo)->val, 1, 1);
                  (yyval.nodo)->left = (yyvsp[0].nodo);
               }
#line 1326 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 129 "calc1.y" /* yacc.c:1646  */
    {
                  int size = (yyvsp[-1].nodo)->size + (yyvsp[0].nodo)->size;
                  char* fullNum = (char*) malloc (size);
                  fullNum[0]=(yyvsp[-1].nodo)->val[0];
                  for(int i=1;i<size;i++) fullNum[i]=(yyvsp[0].nodo)->val[i-1];
                  (yyval.nodo) = initNode(fullNum, size, 2);
                  (yyval.nodo)->left = (yyvsp[-1].nodo);
                  (yyval.nodo)->right = (yyvsp[0].nodo);
                }
#line 1340 "y.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 139 "calc1.y" /* yacc.c:1646  */
    {
                  (yyval.nodo) = initNode((yyvsp[0].nodo)->val, 1, 2);
                  (yyval.nodo)->left = (yyvsp[0].nodo);
            }
#line 1349 "y.tab.c" /* yacc.c:1646  */
  ...
  case 8:
#line 144 "calc1.y" /* yacc.c:1646  */
    {
                  char* input = (char*) malloc (1);
                  input[0] = (yyvsp[0].sval).val[0];
                  (yyval.nodo) = initNode(" ", 1, 3); 
                  (yyval.nodo)->val = input;
                }
